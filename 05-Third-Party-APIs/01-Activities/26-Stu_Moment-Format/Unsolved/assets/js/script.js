...
var gradDate = moment("12/5/22", "MM-DD-YY").format("MMMM Do, YYYY");
$("#1a").text(gradDate);

// TODO: 2. What day of the week will 1/1/2022 be?
var weekDay = moment("01/01/2022", "MM-DD-YYYY").format("dddd");
$("#2a").text(weekDay);
