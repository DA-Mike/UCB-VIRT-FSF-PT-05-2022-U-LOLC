...
for (i=0; i < siteh4.length; i++) {
    siteh4[i].setAttribute("style", "color: blue; font-size: 30px; font-weight: bold;");
}

siteTitle.setAttribute("style", "padding-left: 100px; margin: 0;");
